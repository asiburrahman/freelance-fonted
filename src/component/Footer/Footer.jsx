            ...
            <div className=" flex flex-col   px-4 py-8 lg:flex-row  w-11/12 mx-auto">
                ...
                <div className="flex flex-col justify-center pt-6 lg:pt-0">
                    {/* <div className="flex justify-center space-x-4">
                        ...
                        <Link rel="noopener noreferrer" target="_blank" to="www.gmail.com" title="Gmail" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-600 dark:text-gray-50">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-4 h-4">
